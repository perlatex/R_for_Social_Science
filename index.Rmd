...
课程会用到[**Kruschke**](https://sites.google.com/site/doingbayesiandataanalysis/) 的贝叶斯数据分析方法和[Rstan](https://mc-stan.org/users/interfaces/rstan)和 Bürkner's [**brms**](https://github.com/paul-buerkner/brms)宏包，其中数据处理和可视化用到 [**tidyverse**](https://www.tidyverse.org), 您可以在 [这里](http://r4ds.had.co.nz/transform.html) 或者 [这里](http://style.tidyverse.org)
